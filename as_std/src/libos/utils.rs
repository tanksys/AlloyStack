...
pub macro func_type {
    ...
    (open_dir) => (as_hostcall::fdtab::OpenDirFunc),
    (getdents) => (as_hostcall::fdtab::GetDentsFunc),
    ...
    (path_stat) => (as_hostcall::fdtab::PathStatFunc),
    ...
    (fatfs_path_stat) => (as_hostcall::fatfs::FatfsPathStatFunc),
    (fatfs_readdir) => (as_hostcall::fatfs::FatfsReadDirFunc),
    ...
    (buffer_alloc_raw) => (as_hostcall::mm::BufferAllocRawFunc),
    (buffer_register) => (as_hostcall::mm::BufferRegisterFunc),
    (buffer_set_len) => (as_hostcall::mm::BufferSetLenFunc),
    (buffer_len) => (as_hostcall::mm::BufferLenFunc),
...
pub macro hostcall_id {
    ...
    (open_dir) => (as_hostcall::CommonHostCall::OpenDir),
    (getdents) => (as_hostcall::CommonHostCall::GetDents),
    ...
    (path_stat) => (as_hostcall::CommonHostCall::PathStat),
    ...
    (fatfs_path_stat) => (as_hostcall::CommonHostCall::FatfsPathStat),
    (fatfs_readdir) => (as_hostcall::CommonHostCall::FatfsReadDir),
    ...
    (buffer_alloc_raw) => (as_hostcall::CommonHostCall::BufferAllocRaw),
    (buffer_register) => (as_hostcall::CommonHostCall::BufferRegister),
    (buffer_set_len) => (as_hostcall::CommonHostCall::BufferSetLen),
    (buffer_len) => (as_hostcall::CommonHostCall::BufferLen),
