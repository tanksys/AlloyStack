...
SYMLINK_PATH="/home/as-group/wyd/final/AlloyStack/target/release/libwasmtime_mapper.so"
if [ -L "$SYMLINK_PATH" ]; then
  echo "Symlink already exists, updating..."
  rm "$SYMLINK_PATH"
fi

ln -s /home/as-group/wyd/final/AlloyStack/user/wasmtime_mapper/target/x86_64-unknown-none/release/libwasmtime_mapper.so /home/as-group/wyd/final/AlloyStack/target/release/libwasmtime_mapper.so
