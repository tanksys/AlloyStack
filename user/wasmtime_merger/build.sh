...
"$WASI_CXX" merger_ori.cpp -o merger.wasm -fno-exceptions -fno-rtti -ffast-math -funroll-loops -fomit-frame-pointer -Ofast
...
ln -sfn "$SCRIPT_DIR/target/x86_64-unknown-none/release/libwasmtime_merger.so" \
  "$REPO_ROOT/target/release/libwasmtime_merger.so"
